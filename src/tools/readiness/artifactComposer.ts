...
export class ReadinessArtifactComposer {
  ...
  async observe(toolName: string, result: unknown): Promise<ReadinessDecisionArtifact | null> {
    ...
    return {
      ...
      observedWeakSignals: parts.pattern.observedWeakSignals,
      ...
      weakMatchedSignals: parts.comparison.weakMatchedSignals,
      weakMissingSignals: parts.comparison.weakMissingSignals,
      timelineEstimate: {
        ...
        snapshotProxyTotalDaysMedian: parts.estimate.snapshotProxyTotalDaysMedian,
        snapshotProxyTotalDaysP25: parts.estimate.snapshotProxyTotalDaysP25,
        snapshotProxyTotalDaysP75: parts.estimate.snapshotProxyTotalDaysP75,
